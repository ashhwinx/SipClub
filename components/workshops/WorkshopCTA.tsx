...
const WorkshopCTA: React.FC = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 2. Background Marquee (smooth, no repaint spam)
  ...
  return (
    <section className="relative w-full bg-[#004632] overflow-hidden py-24 md:py-32 border-t-2 border-[#FEF8DD]/20">
      ...
      <div className="absolute top-1/2 left-0 w-full -translate-y-1/2 z-0 opacity-10 pointer-events-none">
        <div
          ref={marqueeRef}
          className="whitespace-nowrap font-heading text-[20vw] text-[#FEF8DD] leading-none will-change-transform"
        >
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10 text-center flex flex-col items-center">
        ...
        <div className="mb-10 relative">
          ...
          <div
            ref={stampRef}
            className="absolute -top-6 -right-6 md:-top-12 md:-right-20 w-24 h-24 md:w-36 md:h-36 rounded-full border-2 border-[#BDD0A0] flex items-center justify-center bg-[#004632] text-[#BDD0A0] shadow-lg will-change-transform"
          >
